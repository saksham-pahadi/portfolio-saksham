...
const items = [
  {
    ...
    desc: "Product builds using Next.js, TypeScript, MongoDB and component-driven UI systems.",
  },
  {
    year: "2023—2024",
    role: "Cognizant",
    desc: "Professional start in BPO, followed by a focused transition into software engineering and modern web development.",
  },
  {
    year: "Always",
    role: "Independent Builder",
    desc: "Experiments, clones, AI utilities, game systems, landing pages and lots of time spent figuring out why something is broken.",
  },
];
